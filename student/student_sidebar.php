...
@media screen and (max-height: 850px) {
  ...
  <a href="student_dashboard.php"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
  <hr style="background-color:black;">
  <a href="student_viewmarks.php"><i class="fa fa-book" aria-hidden="true"></i> View Marks</a>
 
  <hr style="background-color:black;">
    <a href="student_viewattendance.php"><i class="fa fa-calendar" aria-hidden="true"></i> View Attendance</a>

   
  <hr style="background-color:black;">
    <a href="student_notice.php"><i class="fa fa-sticky-note" aria-hidden="true"></i> Notice</a>
    
    <hr style="background-color:black;">
    <a href="student_feedback.php"><i class="fa fa-comments-o" aria-hidden="true"></i> Feedback</a>
    <hr style="background-color:black;">
