...
@media screen and (max-height: 850px) {
  ...
  <a href="faculty_dashboard.php"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
  <hr style="background-color:black;">
  <a href="faculty_addmarks.php"><i class="fa fa-plus" aria-hidden="true"></i> Add Student Marks</a>
 
  <hr style="background-color:black;">
    <a href="faculty_addattendance.php"><i class="fa fa-plus" aria-hidden="true"></i> Add Student Attendance</a>

   
  <hr style="background-color:black;">
    <a href="faculty_notice.php"><i class="fa fa-sticky-note" aria-hidden="true"></i> Notice</a>
    
    <hr style="background-color:black;">
    <a href="faculty_attendance.php"><i class="fa fa-calendar" aria-hidden="true"></i> Your Attendance</a>
    <hr style="background-color:black;">
