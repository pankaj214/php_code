...
@media screen and (max-height: 850px) {
  ...
  <a href="transporthead_dashboard.php"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
  <hr style="background-color:black;">
  <a href="transporthead_busroute.php"><i class="fa fa-bus" aria-hidden="true"></i> Bus route</a>
 
  <hr style="background-color:black;">
    <a href="transporthead_bustimings.php"><i class="fa fa-clock-o" aria-hidden="true"></i> Bus timings</a>

   
  <hr style="background-color:black;">
    <a href="transporthead_driverdetails.php"><i class="fa fa-address-card-o" aria-hidden="true"></i> Driver details</a>
    
    <hr style="background-color:black;">
    <a href="transporthead_notice.php"><i class="fa fa-calendar" aria-hidden="true"></i> Notice</a>
    <hr style="background-color:black;">
